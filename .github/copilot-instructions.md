...
Review this repository as a Go CLI for querying institutional trade data from VolumeLeaders. It uses browser cookie extraction for authentication, compact JSON stdout by default, JSON Schema discovery, output schema discovery, and MCP for local trusted clients.
