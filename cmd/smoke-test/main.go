...
func buildStaticCases(date string) map[string]smokeCase {
	return map[string]smokeCase{
		...
		"trade cluster-bombs":     readOnly("trade cluster-bombs", "AAPL", "--days", "3", "--length", "10"),
		"trade clusters":          readOnly("trade clusters", "AAPL", "--days", "7", "--length", "10"),
		...
		"trade list":              readOnly("trade list", "AAPL", "--days", "7", "--length", "10"),
