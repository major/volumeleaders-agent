...
- Treat broken stdout/stderr discipline as P1. Command output belongs on stdout as compact JSON by default, optional CSV/TSV where supported, or raw indented JSON for `schema`; diagnostics and errors belong on stderr through `slog`.
