...
func TestRootCommandWiresStructCLIFeatures(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantOuts:    []string{"watchlists", "save-watchlist", "delete-watchlist", "trades", "trade-levels", "trade-clusters", "trade-cluster-bombs", "top10-clusters", "top100-clusters", "top30-10x-99pct", "top30-10x-99pct-clusters", "top100-dark-pool-20x", "top100-dark-pool-20x-clusters", "top100-leveraged-etfs", "top100-leveraged-etfs-clusters", "top100-dark-pool-sweeps", "top100-dark-pool-sweeps-clusters", "phantom", "offsetting", "overbought", "overbought-clusters", "oversold", "oversold-clusters"},
