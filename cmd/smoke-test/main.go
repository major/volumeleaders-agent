...
// schemaEntry is the small subset of JSON Schema output needed to discover
// runnable command paths.
type schemaEntry struct {
	Title       string   `json:"title"`
	Subcommands []string `json:"x-flag-subcommands"`
}
...
func buildStaticCases(date string) map[string]smokeCase {
	return map[string]smokeCase{
		...
		"report dark-pool-20x":            readOnly("report dark-pool-20x", "AAPL", "--days", "1"),
		"report disproportionately-large": readOnly("report disproportionately-large", "AAPL", "--days", "1"),
		"report leveraged-etfs":           readOnly("report leveraged-etfs", "TQQQ", "--days", "1"),
		"report list":                     readOnly("report list"),
		"report offsetting-trades":        readOnly("report offsetting-trades", "AAPL", "--days", "1"),
		"report phantom-trades":           readOnly("report phantom-trades", "AAPL", "--days", "1"),
		"report rsi-overbought":           readOnly("report rsi-overbought", "AAPL", "--days", "1"),
		"report rsi-oversold":             readOnly("report rsi-oversold", "AAPL", "--days", "1"),
		"report top-30-rank-10x-99th":     readOnly("report top-30-rank-10x-99th", "AAPL", "--days", "1"),
		"report top-10-rank":              readOnly("report top-10-rank", "AAPL", "--days", "1"),
		"report top-100-rank":             readOnly("report top-100-rank", "AAPL", "--days", "1"),
		...
		"trade dashboard":                 readOnly("trade dashboard", "AAPL", "--days", "1"),
