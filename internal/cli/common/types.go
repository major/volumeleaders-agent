...
// returns only matching rows. It is string-backed so JSON Schema discovery can
// expose supported values while the CLI still accepts the same numeric-looking
// arguments users pass today.
