...
func TestRootCommandWiresStructCLIFeatures(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantOuts:    []string{"trades", "trade-clusters", "top10-clusters", "top100-clusters", "phantom", "offsetting", "overbought", "oversold"},
